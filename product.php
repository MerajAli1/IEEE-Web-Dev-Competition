		            ...
		            <div class="row">
		            	<div class="col-sm-6">
		            		...
		            		<form class="form-inline" id="productForm" >
		            			...
		            			<div class="form-group">
			            			<div class="input-group col-sm-5">
                                        <select id="country" class="form-control" id="edit_name" name="ordersize" class="form-select">
										 <?php 
										    $stmt = $conn->prepare("SELECT * FROM Size");
											$stmt->execute();
											foreach($stmt as $row){
											$address =$row['name'] . ' : Shoulder:- ' .  $row['shoulder'] . ' inches , Chest:- ' . $row['chest'] . ' inches , Wasit:- ' . $row['waist'] . ' inches , Hips:- ' . $row['hips'] . " inches";;
